...
#define SIMULATION_INTERVAL 3
#define SENSOR_TYPE "water_level_sensor"

/* Log configuration */
#include "sys/log.h"
#define LOG_MODULE "Water sensor"
#define LOG_LEVEL LOG_LEVEL_APP


PROCESS(water_level_server, "Server for water level sensor");
AUTOSTART_PROCESSES(&water_level_server);
...
extern coap_resource_t water_level_sensor; 
...
PROCESS_THREAD(water_level_server, ev, data)
{
    ...
    coap_activate_resource(&water_level_sensor, "water_level_sensor");
	...
	while(!registered){
		...
		LOG_INFO("[WATER LEVEL] sending registration message\n");	
    ...
    LOG_INFO("Starting water level Server\n");
