...
#define SENSOR_TYPE "led_ph_actuator"

/* Log configuration */
#include "sys/log.h"
#define LOG_MODULE "Led ph node"
#define LOG_LEVEL LOG_LEVEL_APP

PROCESS(led_ph_server, "Server for ph led");
AUTOSTART_PROCESSES(&led_ph_server);
...
extern coap_resource_t res_led_ph;
...
PROCESS_THREAD(led_ph_server, ev, data)
{
	...
	while(!registered){
		...
		LOG_INFO("[ph LED] sending registration message\n");	
	...
	LOG_INFO("Starting ph led node\n");
	
	coap_activate_resource(&res_led_ph, "res_led_ph");  
