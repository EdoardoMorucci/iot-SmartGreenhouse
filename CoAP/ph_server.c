...
#define SENSOR_TYPE "pH_sensor"

/* Log configuration */
#include "sys/log.h"
#define LOG_MODULE "ph"
#define LOG_LEVEL LOG_LEVEL_APP


PROCESS(pH_server, "Server for pH sensor");
AUTOSTART_PROCESSES(&pH_server);
...
PROCESS_THREAD(pH_server, ev, data)
{
    ...
    coap_activate_resource(&pH_sensor, "pH_sensor");
	...
	while(!registered){
		...
		LOG_INFO("[pH] sending registration message\n");	
